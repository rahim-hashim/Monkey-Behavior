...
if ~wth1.Success          % If the WithThenHold failed, (either fixation is not acquired or broken during hold)
    ...
    eventmarker(102)       % WrputThenHold Success
end
...
if TrialRecord.User.fix_offset == 0
    wth2a.WaitTime = 0;
else
...
if airpuff_mag_outcome == 1
    trace_interval = 1460;
elseif airpuff_mag_outcome == 0.5
    trace_interval = 1490;
end
