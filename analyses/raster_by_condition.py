...
def raster_by_condition(session_df, session_obj):
	...
	axarr[0][0].text(0, 1.08, 'CS On', ha='center', va='center', fontsize='x-large')
	axarr[0][0].text(cs_time_min, 1.08, 'Delay', ha='center', va='center', fontsize='x-large')
	axarr[0][0].text(trace_time_min, 1.08, 'Outcome', ha='center', va='center', fontsize='x-large')
	...
	plot_title = 'raster_by_cond_{}.png'.format(condition)
